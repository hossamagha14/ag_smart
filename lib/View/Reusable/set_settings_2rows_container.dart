...
class SetSettings2RowsContainer extends StatelessWidget {
  ...
  final bool visible;
  final function;
  const SetSettings2RowsContainer(
      {Key? key,
        ...
        Visibility(
          ...
          child: Padding(
            padding: EdgeInsets.fromLTRB(
                MediaQuery.of(context).size.width * 0.03, MediaQuery.of(context).size.width * 0.03, 0, 0),
            child: InkWell(
                onTap: function,
                child: const Icon(
                  Icons.delete,
